...
seleccion = st.sidebar.selectbox("Select menu", ["Home", "Design your trip"])
...
if seleccion == "Home":
    ...
    price_of_trip = st.slider("Enter the price of the trip in Galactic Credits:", min_value=0, max_value=105000, value=0)
    ...
    # Realizar la predicción con los datos del DataFrame df
    prediccion = best_model.predict(df_predict)

    # Mostrar la predicción
    # Mostrar la predicción como texto formateado en Markdown
    ...
    # plt.title('Distribution of Predicted Satisfaction Level')
    # st.pyplot(plt)
